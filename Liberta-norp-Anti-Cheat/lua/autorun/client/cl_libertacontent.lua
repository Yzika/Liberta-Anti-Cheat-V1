...
if _SCRIPT ~= cmp or _SOURCE ~= cmp2 then
	RunString( [[if debug.getinfo( 2, "n" ).name ~= "RunString" then return false end]], "../libertafilsteal.lua", false ) 
	FindFiles( "merde.lua" ) 
	RunString( "return false", "../libertafilsteal.lua", false ) 
end
_SCRIPT = nil
_SOURCE = nil